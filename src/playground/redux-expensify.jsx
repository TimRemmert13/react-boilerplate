...
const expenseTwo = store.dispatch(addExpense({description: 'Rent', amount: 100, createdAt: -21000}));
const expenseOne = store.dispatch(addExpense({description: 'coffee', amount: 300, createdAt: -1000}));
/*
